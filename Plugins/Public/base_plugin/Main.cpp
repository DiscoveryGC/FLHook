		...
		while (ini.read_header())
		{
			if (ini.is_header("recipe"))
			{
				...
				while (ini.read_value())
				{
					...
					{
						recipe.factory_type = stows(ini.get_value_string(0));
					}
					else if (ini.is_value("recipe_type"))
					{
						recipe_type = ini.get_value_string(0);
					}
		...
		while (ini.read_header())
		{
			if (ini.is_header("recipe"))
			{
				...
				while (ini.read_value())
				{
					...
					{
						recipe.produced_item = CreateID(ini.get_value_string(0));
						// need to store the factory type in string form for autogenerated item list pages
						recipe.factory_type = stows(ini.get_value_string(0)).c_str();
					}
					else if (ini.is_value("recipe_type"))
					{
						recipe_type = ini.get_value_string(0);
