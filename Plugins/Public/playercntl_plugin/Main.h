...
namespace GiveCash
{
	...
	bool UserCmd_GiveCashCombined(uint iClientID, const int &cash, const wstring &wscTargetCharname, const wstring &wscCash, const wstring &wscCharname, const bool &bAnon);
}
